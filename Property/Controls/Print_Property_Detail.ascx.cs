...
{
    public partial class Print_Property_Detail : System.Web.UI.UserControl
    {
        #region PageLoad
        ...
        void GetPropertyDetails()
        {
            try
            {
               ...
               // lblSubTypeofhome.Text = CheckNullOrEmptyvalue(Convert.ToString(dt.Rows[0]["typeown1out"]));
                ...
                //    lblwalk.PostBackUrl = "http://www.walkscore.com/score/loc/lat=" + lat + "/lng=" + lng + "/?utm_source=http://rashmimistry.only4agents.com/&amp;utm_medium=ws_api&amp;utm_campaign=ws_api";
                //}
                //Response.Write(sb);
