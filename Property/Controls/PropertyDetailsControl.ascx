                        ...
                        <div id="Commercial" runat="server">
                          ...
                          <%-- <div id="Div1" runat="server">
                            <div class="bob_clsses" runat="server" id="Div2">
                                ...
                                <h5>Rocco Nanni</h5>
                                <span><i class="fa fa-phone" style="margin: 0 6px 0 0;"></i>905-782-8470</span>
                            </div>
                        </div>--%>
                    </div>
                    <div class="detail_left_section" id="AdditionFeatures" runat="server">
                        ...
                        <div class="Detail_section">
                            ...
                            <div id="PropertyFeature1" runat="server" visible="false">
                                <asp:Label ID="lblPropertyFeature1" runat="server" Text=""></asp:Label>
                            </div>
                            <div id="PropertyFeature2" runat="server" visible="false">
                                <asp:Label ID="lblPropertyFeature2" runat="server" Text=""></asp:Label>
                            </div>
                            <div id="PropertyFeature3" runat="server" visible="false">
                                <asp:Label ID="lblPropertyFeature3" runat="server" Text=""></asp:Label>
                            </div>
                            <div id="PropertyFeature4" runat="server" visible="false">
                                <asp:Label ID="lblPropertyFeature4" runat="server" Text=""></asp:Label>
                            </div>
                            <div id="PropertyFeature5" runat="server" visible="false">
                                <asp:Label ID="lblPropertyFeature5" runat="server" Text=""></asp:Label>
                            </div>
                            <div id="PropertyFeature6" runat="server" visible="false">
                                <asp:Label ID="lblPropertyFeature6" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
                        <div class="Detail_section">
